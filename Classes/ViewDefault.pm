#
#	Module: ViewDefault.pm (2003-02-24) G.J.Watson
#
#	Purpose: Generic OOPS module for interface VIEW data in SQL db
#
#	Date       Version Note
#	========== ======= ========================================================================
#	2003-02-24 v1.00   Produced from TableDefault.pm
...
sub CreateSELECT {
	...
	if (defined($statement)) {
		$self->{SQL_STATEMENT}->[0] = "SELECT".$statement." FROM ".$self->{VIEW_NAME}->[0];
	}
}
